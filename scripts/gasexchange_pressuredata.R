...
#maximum example now
stations <- data.frame(StationID = c(3002, 51441, 3062, 44203, 48977, 3318, 2926, 2925), start = c(1994, 2013, 1994, 2005, 2011, 1996, 1994, 1996), end = c(2013, 2015, 2005, 2011, 2015, 2015, 1996, 2015)) # see weatherstations.csv in /RScripts; these will cover lakes b,c,d,k,l,p,ww.
