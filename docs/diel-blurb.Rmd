...
The time series covered June 11^{th} to August 29^{th} and was received from Saskatoon in a 'cleaned' state (corrected CO~2~). However, in other variables there were outliers in the form of spikes or sonde malfunction and I have taken these away. The data are mostly complete, however. See Figs  \ref{mega}-\ref{turb} for variable vs time plots.

Meteorological variables showed both predictable diel and seasonal variation, and somewhat unpredictable patterns. For example, air temperature predictably increased through June and began to decrease again towards the end of August, with minima at night.  Highest PAR (measured in air not water) occurred in June consistent with long days and a direct position of the sun, however cloudy days with lower PAR occurred throughout. On the other hand, wind speed and direction were variable at up to daily resolution and did not show strong seasonal trends. Air pressure dipped through the season and was at times, but not consistently, associated with rain events, reflecting the patchy nature of convective summer precipitation. 

Limnological variables were most stable in June, and most variable in August. Stratification occurred intermittently throughout the season as seen in vertical separation of temperature, oxygen and pH, most notably over three events in July. pH was maximal over July, while water temperature was highest in August. CO~2~ mirrored pH, and was above-atmospheric in June, at its lowest in July, and varied the most in August. The variability in pH and CO~2~ was not clearly related to variation in chl, which had a relatively low amplitude of variation throughout the summer until late August when regrettably, the CO~2~ sensor malfunctioned. Generally, chl was highest in late July and the beginning of August. Note that the chl values should still be verified against routines sampling data from that summer.
...
```{r parplots, plot-ref, fig.height = 13, fig.width=9, fig.cap="% of air PAR intercepted at different depths over the study period, by hour. Later in the day it seems the deeper sensor is registering higher PAR which needs some investigation \\label{par}"}
